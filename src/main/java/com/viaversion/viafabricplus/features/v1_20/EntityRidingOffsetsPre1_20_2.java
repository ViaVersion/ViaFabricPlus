...
package com.viaversion.viafabricplus.features.v1_20;
...
public final class EntityRidingOffsetsPre1_20_2 {
    ...
    public static Vec3 getMountedHeightOffset(final Entity entity, final Entity passenger) {
        ...
        switch (entity) {
            ...
            case Chicken chickenEntity -> {
                return new Vec3(0, chickenEntity.getY(0.5D) - chickenEntity.getY(), -0.1F);
            }
            case EnderDragon enderDragonEntity -> yOffset = enderDragonEntity.body.getBbHeight();
            case Hoglin hoglinEntity -> yOffset = hoglinEntity.getBbHeight() - (hoglinEntity.isBaby() ? 0.2F : 0.15F);
            case Llama llama -> {
                return new Vec3(0, entity.getBbHeight() * 0.6F, -0.3F);
            }
            case Phantom phantom -> yOffset = entity.getEyeHeight();
            case Piglin piglin -> yOffset = entity.getBbHeight() * 0.92F;
            case Ravager ravager -> yOffset = 2.1F;
            case SkeletonHorse skeletonHorse -> yOffset -= 0.1875F;
            case Sniffer sniffer -> yOffset = 1.8F;
            case Spider spider -> yOffset = entity.getBbHeight() * 0.5F;
            case Strider striderEntity -> {
            ...
            case Zoglin zoglinEntity -> yOffset = zoglinEntity.getBbHeight() - (zoglinEntity.isBaby() ? 0.2F : 0.15F);
            case AbstractChestedHorse abstractChestedHorse -> yOffset -= 0.25F;
            case AbstractMinecart abstractMinecart -> yOffset = 0F;
            default -> {
            }
        }
