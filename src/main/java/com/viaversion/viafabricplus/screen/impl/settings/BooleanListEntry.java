...
public final class BooleanListEntry extends VFPListEntry {
    ...
    public void mappedRender(DrawContext context, int index, int mouseX, int mouseY, boolean hovered, float tickDelta) {
        ...
        context.drawTextWithShadow(textRenderer, text, this.getWidth() - offset, this.getHeight() / 2 - textRenderer.fontHeight / 2, this.value.getValue() ? Color.GREEN.getRGB() : Color.RED.getRGB());
