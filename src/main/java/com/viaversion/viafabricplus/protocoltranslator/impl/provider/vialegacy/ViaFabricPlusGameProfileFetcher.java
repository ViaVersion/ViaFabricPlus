...
import com.mojang.authlib.DiscoveryService;
...
public final class ViaFabricPlusGameProfileFetcher extends GameProfileFetcher {
    ...
    private static final DiscoveryService DISCOVERY_SERVICE = MinecraftServicesDiscoveryService.create(Proxy.NO_PROXY);
    private static final SessionService SESSION_SERVICE = DISCOVERY_SERVICE.createMinecraftSessionService();
    private static final GameProfileRepository GAME_PROFILE_REPOSITORY = DISCOVERY_SERVICE.createProfileRepository();
