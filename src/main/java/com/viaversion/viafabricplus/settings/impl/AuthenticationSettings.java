...
public final class AuthenticationSettings extends SettingGroup {
    ...
    public final BooleanSetting betaCraftAuthentication = new BooleanSetting(this, Component.translatable("authentication_settings.viafabricplus.beta_craft_authentication"), true);
