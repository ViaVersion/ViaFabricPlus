...
public class Recipes1_11_2 {
    ...
    public static List<RecipeInfo> getRecipes(final ProtocolVersion targetVersion) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_4_2)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_4_6tor1_4_7)) {
            recipes.add(RecipeInfo.of(() -> new FireworkRocketRecipe(CraftingRecipeCategory.MISC)));
        }
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_11)) {
            recipes.add(RecipeInfo.of(() -> new ShulkerBoxColoringRecipe(CraftingRecipeCategory.MISC)));
        }
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_9)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_8)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_7_1)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_12)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_3tob1_3_1)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_11_1)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_10)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_9)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_5tor1_5_1)) {
                recipes.add(RecipeInfo.shaped(Blocks.TRAPPED_CHEST, "#-", '#', Blocks.CHEST, '-', Blocks.TRIPWIRE_HOOK));
            }
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_3_1tor1_3_2)) {
        ...
        if (targetVersion.newerThanOrEquals(ProtocolVersion.v1_8)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_8tob1_8_1)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_6_1)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_0_0tor1_0_1)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_3_1tor1_3_2)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_2_1tor1_2_3)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_2_4tor1_2_5)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.r1_2_1tor1_2_3)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_5tob1_5_2)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_7tob1_7_3)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_6tob1_6_6)) {
            ...
            if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.a1_2_0toa1_2_1_1)) {
                recipes.add(RecipeInfo.shaped(Blocks.GLOWSTONE, "###", "###", "###", '#', Items.GLOWSTONE_DUST));
            }
            recipes.add(RecipeInfo.shaped(Blocks.WHITE_WOOL, "###", "###", "###", '#', Blocks.TRIPWIRE));
        }
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_4tob1_4_1)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.b1_2_0tob1_2_2)) {
        ...
        if (targetVersion.newerThanOrEquals(LegacyProtocolVersion.a1_1_0toa1_1_2_1)) {
