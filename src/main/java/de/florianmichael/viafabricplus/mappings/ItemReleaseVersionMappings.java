...
public class ItemReleaseVersionMappings {
    ...
    public void load() {
        ...
        register(Items.POTTERY_SHARD_ARCHER, VersionRange.andNewer(VersionEnum.r1_19_4));
        ...
        register(Items.POTTERY_SHARD_SKULL, VersionRange.andNewer(VersionEnum.r1_19_4));
