...
public class ItemReleaseVersionMappings {
    ...
    public void load() {
        ...
        register(Items.BAMBOO_BLOCK, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.STRIPPED_BAMBOO_BLOCK, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_PLANKS, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_MOSAIC, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_STAIRS, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_MOSAIC_STAIRS, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_SLAB, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_MOSAIC_SLAB, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_FENCE, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_FENCE_GATE, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_DOOR, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_TRAPDOOR, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_PRESSURE_PLATE, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_BUTTON, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_CHEST_RAFT, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_RAFT, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.CHISELED_BOOKSHELF, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.CAMEL_SPAWN_EGG, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.PIGLIN_HEAD, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.OAK_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.SPRUCE_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BIRCH_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.JUNGLE_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.ACACIA_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.CHERRY_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.DARK_OAK_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.MANGROVE_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.BAMBOO_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.CRIMSON_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
        register(Items.WARPED_HANGING_SIGN, VersionRange.andNewer(VersionEnum.r1_20tor1_20_1));
