...
public final class VisualSettings extends SettingGroup {
    ...
    public final VersionedBooleanSetting fullBlockCropOutline = new VersionedBooleanSetting(this, Text.translatable("visual_settings.viafabricplus.full_block_crop_outline"), VersionRange.andOlder(ProtocolVersion.v1_8));
