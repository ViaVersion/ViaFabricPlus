...
public final class VisualSettings extends SettingGroup {
    ...
    // 1.21 -> 1.20.5
    public final VersionedBooleanSetting hideDownloadTerrainScreenTransitionEffects = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.hide_download_terrain_screen_transition_effects"), VersionRange.andOlder(ProtocolVersion.v1_20_5));

    // 1.20.3 -> 1.20.2
    public final VersionedBooleanSetting lockBlockingArmRotation = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.lock_blocking_arm_rotation"), VersionRange.andOlder(ProtocolVersion.v1_20_2));

    // 1.19.4 -> 1.19.3
    public final VersionedBooleanSetting changeBodyRotationInterpolation = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.change_body_rotation_interpolation"), VersionRange.andOlder(ProtocolVersion.v1_19_3));
    public final VersionedBooleanSetting potionEnchantmentGlint = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.potion_enchantment_glint"), VersionRange.andOlder(ProtocolVersion.v1_19_3));
    ...
    public final VersionedBooleanSetting hideFurnaceRecipeBook = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.hide_furnace_recipe_book"), VersionRange.andOlder(ProtocolVersion.v1_12_2));
    public final VersionedBooleanSetting forceUnicodeFontForNonAsciiLanguages = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.force_unicode_font_for_non_ascii_languages"), VersionRange.andOlder(ProtocolVersion.v1_12_2));
    public final VersionedBooleanSetting sneakInstantly = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.sneak_instantly"), VersionRange.andOlder(ProtocolVersion.v1_12_2));
    ...
    public final VersionedBooleanSetting hideCraftingRecipeBook = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.hide_crafting_recipe_book"), VersionRange.andOlder(ProtocolVersion.v1_11_1));

    // 1.9 -> 1.8.x
    public final VersionedBooleanSetting alwaysRenderCrosshair = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.always_render_crosshair"), VersionRange.andOlder(ProtocolVersion.v1_8));

    // 1.8.x -> 1.7.6 - 1.7.10
    public final VersionedBooleanSetting swingHandOnItemUse = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.swing_hand_on_item_use"), VersionRange.andOlder(ProtocolVersion.v1_7_6));
    public final VersionedBooleanSetting tiltItemPositions = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.tilt_item_positions"), VersionRange.andOlder(ProtocolVersion.v1_7_6));
    public final VersionedBooleanSetting enableLegacyTablist = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.enable_legacy_tablist"), VersionRange.andOlder(ProtocolVersion.v1_7_6));
    ...
    public final VersionedBooleanSetting hideModernHUDElements = new VersionedBooleanSetting(this, Component.translatable("visual_settings.viafabricplus.hide_modern_hud_elements"), VersionRange.andOlder(LegacyProtocolVersion.b1_7tob1_7_3));
