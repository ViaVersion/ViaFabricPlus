...
fun Project.configureVVDependencies(configuration: String) {
    dependencies {
        configuration("com.viaversion:viaversion-common:5.7.2-20260128.111212-9")
        configuration("com.viaversion:viabackwards-common:5.7.2-20260125.121910-1")
        configuration("com.viaversion:viaaprilfools-common:4.0.8")
        configuration("net.raphimc:ViaLegacy:3.0.13")
        configuration("net.raphimc:ViaBedrock:0.0.25-20260124.120426-5") {
